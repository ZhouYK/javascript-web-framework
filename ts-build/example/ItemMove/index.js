...
class Index extends Hoc {
    ...
    render() {
        ...
        <div className="code-source">
          <a href="https://github.com/ZhouYK/iron/blob/master/assets/js/components/ItemMove/index.js" target="blank">
示例代码
          </a>
        </div>
        <ul className="item-move-list">
          <li>
            <ItemMove closed={closed} handleClosed={this.handleClosed} buttons={[
            {
                type: 'alert',
                text: '删除',
