...
class Dashboard extends Component {
    ...
    render() {
        const { width, height, scaleRadio, className, cuStyle: _style, } = this.props;
        const style = Object.assign({}, _style, {
            width,
            height,
        });
        return (<div className={className ? `${className} canvas-wrap` : 'canvas-wrap'} style={style}>
        <canvas style={style} ref={this.getRef} width={scaleRadio * width} height={scaleRadio * height}/>
      </div>);
    }
}
Dashboard.propTypes = {
    ...
    scaleRadio: PropTypes.number,
    anticlockwise: PropTypes.bool,
    score: PropTypes.number,
    cuStyle: PropTypes.object,
};
