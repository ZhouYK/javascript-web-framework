...
class ImgUpload extends Component {
    constructor(options) {
        ...
        this.draw = (img, orientation, preOrientation) => {
            this.img = img;
        ...
        this._calculateHW = (reverse) => {
            if (reverse) {
                var temp = this.canvasWidth;
                this.canvasWidth = this.canvasHeight;
                this.canvasHeight = temp;
            }
            var radioW = this.imgNaturalWidth / this.canvasWidth, radioH = this.imgNaturalHeight / this.canvasHeight;
            if (radioW < radioH) {
